import logging
import os
from src.leitura import ler_configuracoes, garantir_diretorios, ler_categorias
from src.validacao import extrair_dados_observacoes
from src.processamento import processar_dados
from src.relatorios import gerar_indicadores, exportar_graficos, exportar_resultados
...
def main():
    ...
    try:
        # RF01 e RF02: Leitura de dados e config
        ...
        # RF04, RF05, RF08: Processamento (limpeza, tratamento e estatísticas com Pandas/Numpy)
        ...
        # RF08: Tolerância a falhas na execução global
